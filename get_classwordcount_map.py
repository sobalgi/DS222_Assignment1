...
# unit test code
# cat unit_test.txt | python get_classwordcount_map.py | LANG=C sort > out_get_classwordcount_map.txt
...
for line in sys.stdin:
    ...
    for classlabel in classlabels_list:
        print('00lbl %s\t1' % (classlabel))  # emit key-val for each class to find the class counts
        ...
        for word in filtered_words:
            ...
            print('01wrd %s %s\t1' % (classlabel, word))
